...
export const Icons = {
  ...
  Flowchart: <>
    ...
    <path d="M6.5 8v4h5v4M17.5 8v4h-5v4" />
  </>,
  StateDiagram: <>
    <circle cx="6" cy="6" r="3" />
    <circle cx="18" cy="6" r="3" />
    <circle cx="12" cy="18" r="3" />
    <path d="M9 6h6M8 8l2 8M16 8l-2 8" />
  </>,
  ClassDiagram: <>
  ...
  SequenceDiagram: <>
    ...
    <line x1="6" y1="7" x2="6" y2="21" strokeDasharray="2 2" />
    <line x1="18" y1="7" x2="18" y2="21" strokeDasharray="2 2" />
    <path d="M6 10h12M14 8l4 2-4 2" />
    <path d="M18 16H6M10 14l-4 2 4 2" />
  </>,
  // Swimlane icon
  Swimlane: <>
    <rect x="2" y="3" width="20" height="18" rx="2" fill="none" />
    <line x1="2" y1="9" x2="22" y2="9" />
    <text x="4" y="7" fontSize="6" fill="currentColor">A</text>
  </>,
  ...
  Arrow: <path d="M5 12h14M15 6l6 6-6 6" />,
  ...
  // New node shapes
  Flag: <path d="M3 3h15l-4 9 4 9H3V3z" />,
  Trapezoid: <path d="M4 18 7 6h10l3 12H4z" />,
  TrapezoidAlt: <path d="M7 18 4 6h16l-3 12H7z" />,
  DoubleCircle: <>
    <circle cx="12" cy="12" r="10" />
    <circle cx="12" cy="12" r="7" />
  </>,
  ParallelogramAlt: <path d="M2 6 6 18h16l-4-12H2z" />,
  LineSolid: <line x1="2" y1="12" x2="22" y2="12" />,
  LineDotted: <line x1="2" y1="12" x2="22" y2="12" strokeDasharray="4 4" />,
  LineThick: <line x1="2" y1="12" x2="22" y2="12" strokeWidth="4" />,
  ...
  // State Diagram icons
  State: <rect x="3" y="5" width="18" height="14" rx="4" ry="4" />,
  StartState: <circle cx="12" cy="12" r="6" fill="currentColor" />,
  EndState: <>
    <circle cx="12" cy="12" r="8" />
    <circle cx="12" cy="12" r="4" fill="currentColor" />
  </>,
  Choice: <path d="M12 2 2 12l10 10 10-10L12 2z" />,
  Fork: <rect x="4" y="10" width="16" height="4" rx="1" fill="currentColor" />,
  Join: <rect x="4" y="10" width="16" height="4" rx="1" fill="currentColor" />,
  // Class Diagram icons
  Class: <>
    <rect x="3" y="3" width="18" height="18" rx="2" />
    <line x1="3" y1="9" x2="21" y2="9" />
  ...
  // Relationship icons
  Inheritance: <path d="M12 3v12M6 9l6-6 6 6" />,
  Association: <path d="M5 12h14" />,
  Aggregation: <path d="M12 3l-4 4 4 4 4-4-4-4zM12 11v10" />,
  Composition: <path d="M12 3l-4 4 4 4 4-4-4-4zM12 11v10" fill="currentColor" />,
  Dependency: <path d="M5 12h14" strokeDasharray="4 2" />,
  // Fullscreen icons
  Fullscreen: <path d="M8 3H5a2 2 0 0 0-2 2v3m18 0V5a2 2 0 0 0-2-2h-3m0 18h3a2 2 0 0 0 2-2v-3M3 16v3a2 2 0 0 0 2 2h3" />,
  ExitFullscreen: <path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3" />,
}
